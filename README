#  Operating Systems XV6 project

## PA1. Implement syscall (ps, getnice, setnice)

## PA2. Implement CFS scheduling
...
vruntime(1tick) = $(1tick) * (weight\ of\ nice\ 20) / (weight\ of\ current\ process)$

Use millitick unit = $(1 tick) * 1000$
